#!/usr/bin/env python3
"""
MNIST Training Script with Autograd MLP
========================================

This script trains the TwoLayerMLPAutograd on the MNIST handwritten digits
dataset using the autograd engine for automatic differentiation.
...
def train_epoch(model: TwoLayerMLPAutograd, X: np.ndarray, y: np.ndarray,
...
def main():
    """Train and evaluate the autograd model on MNIST."""
    print("=" * 60)
    print("MNIST Training with TwoLayerMLPAutograd (Autograd Engine)")
    print("=" * 60)
    print()
    ...
    # Initialize model
    print("Initializing autograd model...")
